...
const STYLE_LIBRARY = [
  ...
  },
  {
    ...
    techniques: [
      ...
      'motion/react entrance choreography: staggered initial/animate (opacity + scale 0.98 on h1 @delay .2, opacity on subcopy @delay .4, y-20 fade-up badge, x-20 slide bottom-left, y-20 fade-up bottom-right) plus whileHover/whileTap scale (1.02 / 0.98) on every button.',
